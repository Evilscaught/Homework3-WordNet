...
public class WordNet 
{
    ...
    private void initST(String path) throws FileNotFoundException
    {
        ...
        while(fileScanner.hasNext())
        {
            ...
            for (int index = 0; index < keys.length; index++)
            {
                ...
                stSynsets.put(keys[index].toLowerCase(), value);
            }
            
            reverseStSynsets.put(value, keys);
            lineScanner.close();
        }
        fileScanner.close();
    ...
    public String getAssociatedWords(int value)
    {
    ...
    public String sca(String noun1, String noun2) //sca == shortest common ancestor
    {
        ...
        int noun1Val = stSynsets.get(noun1.toLowerCase());
        int noun2Val = stSynsets.get(noun2.toLowerCase());
        
        //Find the ID of the shortest common ancestor of noun1 and noun2
        int ancestorVal = sca.ancestor(noun1Val, noun2Val);
